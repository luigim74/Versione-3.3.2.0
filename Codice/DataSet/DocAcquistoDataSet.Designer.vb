...
<Global.System.Serializable(),  _
 ...
 Global.System.Xml.Serialization.XmlRootAttribute("DocAcquistoDataSet"),  _
 Global.System.ComponentModel.Design.HelpKeywordAttribute("vs.data.DataSet")>  _
Partial Public Class DocAcquistoDataSet
    ...
    Public Overrides Function Clone() As Global.System.Data.DataSet
        Dim cln As DocAcquistoDataSet = CType(MyBase.Clone,DocAcquistoDataSet)
        cln.InitVars
    ...
    Private Sub InitClass()
        Me.DataSetName = "DocAcquistoDataSet"
        Me.Prefix = ""
        Me.Namespace = "http://tempuri.org/DocAcquistoDataSet.xsd"
    ...
    Public Shared Function GetTypedDataSetSchema(ByVal xs As Global.System.Xml.Schema.XmlSchemaSet) As Global.System.Xml.Schema.XmlSchemaComplexType
        Dim ds As DocAcquistoDataSet = New DocAcquistoDataSet()
...
Namespace DocAcquistoDataSetTableAdapters
    ...
    Partial Public Class AcquistiTableAdapter
        ...
        Private Sub InitAdapter()
            ...
            Me._adapter.DeleteCommand.CommandText = "DELETE FROM `Acquisti` WHERE ((`Id` = ?) AND ((? = 1 AND `TipoDoc` IS NULL) OR (`"& _ 
                ...
                "R (`CAB` = ?)) AND ((? = 1 AND `CC` IS NULL) OR (`CC` = ?)) AND ((? = 1 AND `Rat"& _ 
                "a1` IS NULL) OR (`Rata1` = ?)) AND ((? = 1 AND `Rata2` IS NULL) OR (`Rata2` = ?)"& _ 
                ") AND ((? = 1 AND `Rata3` IS NULL) OR (`Rata3` = ?)) AND ((? = 1 AND `DataRata1`"& _ 
                " IS NULL) OR (`DataRata1` = ?)) AND ((? = 1 AND `DataRata2` IS NULL) OR (`DataRa"& _ 
                "ta2` = ?)) AND ((? = 1 AND `DataRata3` IS NULL) OR (`DataRata3` = ?)) AND ((? = "& _ 
                "1 AND `ImportoRata1` IS NULL) OR (`ImportoRata1` = ?)) AND ((? = 1 AND `ImportoR"& _ 
                "ata2` IS NULL) OR (`ImportoRata2` = ?)) AND ((? = 1 AND `ImportoRata3` IS NULL) "& _ 
                "OR (`ImportoRata3` = ?)) AND ((? = 1 AND `RataSaldata1` IS NULL) OR (`RataSaldat"& _ 
                "a1` = ?)) AND ((? = 1 AND `RataSaldata2` IS NULL) OR (`RataSaldata2` = ?)) AND ("& _ 
                "(? = 1 AND `RataSaldata3` IS NULL) OR (`RataSaldata3` = ?)) AND ((? = 1 AND `Cal"& _ 
                "cManuale` IS NULL) OR (`CalcManuale` = ?)) AND ((? = 1 AND `CalcAutomatico` IS N"& _ 
                "ULL) OR (`CalcAutomatico` = ?)) AND ((? = 1 AND `CausaleTrasporto` IS NULL) OR ("& _ 
                "`CausaleTrasporto` = ?)) AND ((? = 1 AND `DataOraTrasporto` IS NULL) OR (`DataOr"& _ 
                "aTrasporto` = ?)) AND ((? = 1 AND `NomeVettore` IS NULL) OR (`NomeVettore` = ?))"& _ 
                " AND ((? = 1 AND `Porto` IS NULL) OR (`Porto` = ?)) AND ((? = 1 AND `AspettoBeni"& _ 
                "` IS NULL) OR (`AspettoBeni` = ?)) AND ((? = 1 AND `NumColli` IS NULL) OR (`NumC"& _ 
                "olli` = ?)) AND ((? = 1 AND `Peso` IS NULL) OR (`Peso` = ?)) AND ((? = 1 AND `No"& _ 
                "teAgg` IS NULL) OR (`NoteAgg` = ?)) AND ((? = 1 AND `Note` IS NULL) OR (`Note` ="& _ 
                " ?)) AND ((? = 1 AND `NoteInt` IS NULL) OR (`NoteInt` = ?)) AND ((? = 1 AND `Cod"& _ 
                "Dest` IS NULL) OR (`CodDest` = ?)) AND ((? = 1 AND `Destinatario` IS NULL) OR (`"& _ 
                "Destinatario` = ?)) AND ((? = 1 AND `Indirizzo1` IS NULL) OR (`Indirizzo1` = ?))"& _ 
                " AND ((? = 1 AND `Cap1` IS NULL) OR (`Cap1` = ?)) AND ((? = 1 AND `Città1` IS NU"& _ 
                "LL) OR (`Città1` = ?)) AND ((? = 1 AND `Provincia1` IS NULL) OR (`Provincia1` = "& _ 
                "?)) AND ((? = 1 AND `Nazione1` IS NULL) OR (`Nazione1` = ?)) AND ((? = 1 AND `Pi"& _ 
                "va` IS NULL) OR (`Piva` = ?)) AND ((? = 1 AND `CodFisc` IS NULL) OR (`CodFisc` ="& _ 
                " ?)) AND ((? = 1 AND `Destinazione` IS NULL) OR (`Destinazione` = ?)) AND ((? = "& _ 
                "1 AND `Indirizzo2` IS NULL) OR (`Indirizzo2` = ?)) AND ((? = 1 AND `Cap2` IS NUL"& _ 
                "L) OR (`Cap2` = ?)) AND ((? = 1 AND `Città2` IS NULL) OR (`Città2` = ?)) AND ((?"& _ 
                " = 1 AND `Provincia2` IS NULL) OR (`Provincia2` = ?)) AND ((? = 1 AND `Nazione2`"& _ 
                " IS NULL) OR (`Nazione2` = ?)) AND ((? = 1 AND `Stato` IS NULL) OR (`Stato` = ?)"& _ 
            ...
            Me._adapter.InsertCommand.CommandText = "INSERT INTO `Acquisti` (`TipoDoc`, `DataDoc`, `NumDoc`, `TotNetto`, `CodIva`, `Al"& _ 
                ...
                "`, `ABI`, `CAB`, `CC`, `Rata1`, `Rata2`, `Rata3`, `DataRata1`, `DataRata2`, `Dat"& _ 
                "aRata3`, `ImportoRata1`, `ImportoRata2`, `ImportoRata3`, `RataSaldata1`, `RataSa"& _ 
                "ldata2`, `RataSaldata3`, `CalcManuale`, `CalcAutomatico`, `CausaleTrasporto`, `D"& _ 
                "ataOraTrasporto`, `NomeVettore`, `Porto`, `AspettoBeni`, `NumColli`, `Peso`, `No"& _ 
                "teAgg`, `Note`, `NoteInt`, `CodDest`, `Destinatario`, `Indirizzo1`, `Cap1`, `Cit"& _ 
                "tà1`, `Provincia1`, `Nazione1`, `Piva`, `CodFisc`, `Destinazione`, `Indirizzo2`,"& _ 
            ...
            Me._adapter.UpdateCommand.CommandText = "UPDATE `Acquisti` SET `TipoDoc` = ?, `DataDoc` = ?, `NumDoc` = ?, `TotNetto` = ?,"& _ 
                ...
                "`CAB` = ?, `CC` = ?, `Rata1` = ?, `Rata2` = ?, `Rata3` = ?, `DataRata1` = ?, `Da"& _ 
                "taRata2` = ?, `DataRata3` = ?, `ImportoRata1` = ?, `ImportoRata2` = ?, `ImportoR"& _ 
                "ata3` = ?, `RataSaldata1` = ?, `RataSaldata2` = ?, `RataSaldata3` = ?, `CalcManu"& _ 
                "ale` = ?, `CalcAutomatico` = ?, `CausaleTrasporto` = ?, `DataOraTrasporto` = ?, "& _ 
                "`NomeVettore` = ?, `Porto` = ?, `AspettoBeni` = ?, `NumColli` = ?, `Peso` = ?, `"& _ 
                "NoteAgg` = ?, `Note` = ?, `NoteInt` = ?, `CodDest` = ?, `Destinatario` = ?, `Ind"& _ 
                "irizzo1` = ?, `Cap1` = ?, `Città1` = ?, `Provincia1` = ?, `Nazione1` = ?, `Piva`"& _ 
                " = ?, `CodFisc` = ?, `Destinazione` = ?, `Indirizzo2` = ?, `Cap2` = ?, `Città2` "& _ 
                "= ?, `Provincia2` = ?, `Nazione2` = ?, `Stato` = ?, `Commento` = ? WHERE ((`Id` "& _ 
                "= ?) AND ((? = 1 AND `TipoDoc` IS NULL) OR (`TipoDoc` = ?)) AND ((? = 1 AND `Dat"& _ 
                "aDoc` IS NULL) OR (`DataDoc` = ?)) AND ((? = 1 AND `NumDoc` IS NULL) OR (`NumDoc"& _ 
                "` = ?)) AND ((? = 1 AND `TotNetto` IS NULL) OR (`TotNetto` = ?)) AND ((? = 1 AND"& _ 
                " `CodIva` IS NULL) OR (`CodIva` = ?)) AND ((? = 1 AND `Aliquota` IS NULL) OR (`A"& _ 
                "liquota` = ?)) AND ((? = 1 AND `TotIva` IS NULL) OR (`TotIva` = ?)) AND ((? = 1 "& _ 
                "AND `TotDoc` IS NULL) OR (`TotDoc` = ?)) AND ((? = 1 AND `TotDocSaldare` IS NULL"& _ 
                ") OR (`TotDocSaldare` = ?)) AND ((? = 1 AND `RitenutaAcc` IS NULL) OR (`Ritenuta"& _ 
                "Acc` = ?)) AND ((? = 1 AND `RitAccPerc1` IS NULL) OR (`RitAccPerc1` = ?)) AND (("& _ 
                "? = 1 AND `RitAccPerc2` IS NULL) OR (`RitAccPerc2` = ?)) AND ((? = 1 AND `DocInc"& _ 
                "ludibile` IS NULL) OR (`DocIncludibile` = ?)) AND ((? = 1 AND `PrezzoIvato` IS N"& _ 
                "ULL) OR (`PrezzoIvato` = ?)) AND ((? = 1 AND `DocSaldato` IS NULL) OR (`DocSalda"& _ 
                "to` = ?)) AND ((? = 1 AND `ModPagamento` IS NULL) OR (`ModPagamento` = ?)) AND ("& _ 
                "(? = 1 AND `Banca` IS NULL) OR (`Banca` = ?)) AND ((? = 1 AND `ABI` IS NULL) OR "& _ 
                "(`ABI` = ?)) AND ((? = 1 AND `CAB` IS NULL) OR (`CAB` = ?)) AND ((? = 1 AND `CC`"& _ 
                " IS NULL) OR (`CC` = ?)) AND ((? = 1 AND `Rata1` IS NULL) OR (`Rata1` = ?)) AND "& _ 
                "((? = 1 AND `Rata2` IS NULL) OR (`Rata2` = ?)) AND ((? = 1 AND `Rata3` IS NULL) "& _ 
                "OR (`Rata3` = ?)) AND ((? = 1 AND `DataRata1` IS NULL) OR (`DataRata1` = ?)) AND"& _ 
                " ((? = 1 AND `DataRata2` IS NULL) OR (`DataRata2` = ?)) AND ((? = 1 AND `DataRat"& _ 
                "a3` IS NULL) OR (`DataRata3` = ?)) AND ((? = 1 AND `ImportoRata1` IS NULL) OR (`"& _ 
                "ImportoRata1` = ?)) AND ((? = 1 AND `ImportoRata2` IS NULL) OR (`ImportoRata2` ="& _ 
                " ?)) AND ((? = 1 AND `ImportoRata3` IS NULL) OR (`ImportoRata3` = ?)) AND ((? = "& _ 
                "1 AND `RataSaldata1` IS NULL) OR (`RataSaldata1` = ?)) AND ((? = 1 AND `RataSald"& _ 
                "ata2` IS NULL) OR (`RataSaldata2` = ?)) AND ((? = 1 AND `RataSaldata3` IS NULL) "& _ 
                "OR (`RataSaldata3` = ?)) AND ((? = 1 AND `CalcManuale` IS NULL) OR (`CalcManuale"& _ 
                "` = ?)) AND ((? = 1 AND `CalcAutomatico` IS NULL) OR (`CalcAutomatico` = ?)) AND"& _ 
                " ((? = 1 AND `CausaleTrasporto` IS NULL) OR (`CausaleTrasporto` = ?)) AND ((? = "& _ 
                "1 AND `DataOraTrasporto` IS NULL) OR (`DataOraTrasporto` = ?)) AND ((? = 1 AND `"& _ 
                "NomeVettore` IS NULL) OR (`NomeVettore` = ?)) AND ((? = 1 AND `Porto` IS NULL) O"& _ 
                "R (`Porto` = ?)) AND ((? = 1 AND `AspettoBeni` IS NULL) OR (`AspettoBeni` = ?)) "& _ 
                "AND ((? = 1 AND `NumColli` IS NULL) OR (`NumColli` = ?)) AND ((? = 1 AND `Peso` "& _ 
                "IS NULL) OR (`Peso` = ?)) AND ((? = 1 AND `NoteAgg` IS NULL) OR (`NoteAgg` = ?))"& _ 
                " AND ((? = 1 AND `Note` IS NULL) OR (`Note` = ?)) AND ((? = 1 AND `NoteInt` IS N"& _ 
                "ULL) OR (`NoteInt` = ?)) AND ((? = 1 AND `CodDest` IS NULL) OR (`CodDest` = ?)) "& _ 
                "AND ((? = 1 AND `Destinatario` IS NULL) OR (`Destinatario` = ?)) AND ((? = 1 AND"& _ 
                " `Indirizzo1` IS NULL) OR (`Indirizzo1` = ?)) AND ((? = 1 AND `Cap1` IS NULL) OR"& _ 
                " (`Cap1` = ?)) AND ((? = 1 AND `Città1` IS NULL) OR (`Città1` = ?)) AND ((? = 1 "& _ 
                "AND `Provincia1` IS NULL) OR (`Provincia1` = ?)) AND ((? = 1 AND `Nazione1` IS N"& _ 
                "ULL) OR (`Nazione1` = ?)) AND ((? = 1 AND `Piva` IS NULL) OR (`Piva` = ?)) AND ("& _ 
                "(? = 1 AND `CodFisc` IS NULL) OR (`CodFisc` = ?)) AND ((? = 1 AND `Destinazione`"& _ 
                " IS NULL) OR (`Destinazione` = ?)) AND ((? = 1 AND `Indirizzo2` IS NULL) OR (`In"& _ 
                "dirizzo2` = ?)) AND ((? = 1 AND `Cap2` IS NULL) OR (`Cap2` = ?)) AND ((? = 1 AND"& _ 
                " `Città2` IS NULL) OR (`Città2` = ?)) AND ((? = 1 AND `Provincia2` IS NULL) OR ("& _ 
                "`Provincia2` = ?)) AND ((? = 1 AND `Nazione2` IS NULL) OR (`Nazione2` = ?)) AND "& _ 
                "((? = 1 AND `Stato` IS NULL) OR (`Stato` = ?)) AND ((? = 1 AND `Commento` IS NUL"& _ 
                "L) OR (`Commento` = ?)))"
        ...
        Private Sub InitCommandCollection()
            ...
            Me._commandCollection(0).CommandText = "SELECT Id, TipoDoc, DataDoc, NumDoc, TotNetto, CodIva, Aliquota, TotIva, TotDoc, "& _ 
                ...
                "o, DocSaldato, ModPagamento, Banca, ABI, CAB, CC, Rata1, Rata2, Rata3, DataRata1"& _ 
                ", DataRata2, DataRata3, ImportoRata1, ImportoRata2, ImportoRata3, RataSaldata1, "& _ 
                "RataSaldata2, RataSaldata3, CalcManuale, CalcAutomatico, CausaleTrasporto, DataO"& _ 
                "raTrasporto, NomeVettore, Porto, AspettoBeni, NumColli, Peso, NoteAgg, [Note], N"& _ 
                "oteInt, CodDest, Destinatario, Indirizzo1, Cap1, Città1, Provincia1, Nazione1, P"& _ 
                "iva, CodFisc, Destinazione, Indirizzo2, Cap2, Città2, Provincia2, Nazione2, Stat"& _ 
                "o, Commento FROM Acquisti"
        ...
        Public Overloads Overridable Function Fill(ByVal dataTable As DocAcquistoDataSet.AcquistiDataTable) As Integer
        ...
        Public Overloads Overridable Function GetData() As DocAcquistoDataSet.AcquistiDataTable
            Me.Adapter.SelectCommand = Me.CommandCollection(0)
            Dim dataTable As DocAcquistoDataSet.AcquistiDataTable = New DocAcquistoDataSet.AcquistiDataTable()
        ...
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         Global.System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0"),  _
         Global.System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")>  _
        Public Overloads Overridable Function Update(ByVal dataTable As DocAcquistoDataSet.AcquistiDataTable) As Integer
        ...
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         Global.System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0"),  _
         Global.System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")>  _
        Public Overloads Overridable Function Update(ByVal dataSet As DocAcquistoDataSet) As Integer
        ...
        Public Overloads Overridable Function Delete( _
            ...
            Else
                ...
                Me.Adapter.DeleteCommand.Parameters(40).Value = CType(Original_CC,String)
            End If
        ...
        Public Overloads Overridable Function Update( _
            ...
            Else
                Me.Adapter.UpdateCommand.Parameters(19).Value = CType(CC,String)
            End If
            ...
            Else
                ...
                Me.Adapter.UpdateCommand.Parameters(101).Value = CType(Original_CC,String)
            End If
    ...
    Partial Public Class TableAdapterManager
        ...
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         Global.System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")>  _
        Private Function UpdateUpdatedRows(ByVal dataSet As DocAcquistoDataSet, ByVal allChangedRows As Global.System.Collections.Generic.List(Of Global.System.Data.DataRow), ByVal allAddedRows As Global.System.Collections.Generic.List(Of Global.System.Data.DataRow)) As Integer
        ...
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         Global.System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")>  _
        Private Function UpdateInsertedRows(ByVal dataSet As DocAcquistoDataSet, ByVal allAddedRows As Global.System.Collections.Generic.List(Of Global.System.Data.DataRow)) As Integer
            Dim result As Integer = 0
            If (Not (Me._acquistiTableAdapter) Is Nothing) Then
        ...
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         Global.System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")>  _
        Private Function UpdateDeletedRows(ByVal dataSet As DocAcquistoDataSet, ByVal allChangedRows As Global.System.Collections.Generic.List(Of Global.System.Data.DataRow)) As Integer
            Dim result As Integer = 0
            If (Not (Me._acquistiTableAdapter) Is Nothing) Then
        ...
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         Global.System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")>  _
        Public Overridable Function UpdateAll(ByVal dataSet As DocAcquistoDataSet) As Integer
