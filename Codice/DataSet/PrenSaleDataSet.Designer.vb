...
<Global.System.Serializable(),  _
 ...
 Global.System.Xml.Serialization.XmlRootAttribute("PrenSaleDataSet"),  _
 Global.System.ComponentModel.Design.HelpKeywordAttribute("vs.data.DataSet")>  _
Partial Public Class PrenSaleDataSet
    ...
    Public Overrides Function Clone() As Global.System.Data.DataSet
        Dim cln As PrenSaleDataSet = CType(MyBase.Clone,PrenSaleDataSet)
        cln.InitVars
    ...
    Private Sub InitClass()
        Me.DataSetName = "PrenSaleDataSet"
        Me.Prefix = ""
        Me.Namespace = "http://tempuri.org/PrenSaleDataSet.xsd"
    ...
    Public Shared Function GetTypedDataSetSchema(ByVal xs As Global.System.Xml.Schema.XmlSchemaSet) As Global.System.Xml.Schema.XmlSchemaComplexType
        Dim ds As PrenSaleDataSet = New PrenSaleDataSet()
    ...
    Partial Public Class PrenSaleDataTable
        ...
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         Global.System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")>  _
        Public Overloads Function AddPrenSaleRow(ByVal Data As Date, ByVal IdRisorsa As String, ByVal DescrizioneRisorsa As String, ByVal Cliente As String, ByVal OraInizio As String, ByVal OraFine As String, ByVal Persone As String, ByVal Stato As String, ByVal Colore As String, ByVal Note As String) As PrenSaleRow
            Dim rowPrenSaleRow As PrenSaleRow = CType(Me.NewRow,PrenSaleRow)
            Dim columnValuesArray() As Object = New Object() {Nothing, Data, IdRisorsa, DescrizioneRisorsa, Cliente, OraInizio, OraFine, Persone, Stato, Colore, Note}
    ...
    Partial Public Class PrenSaleRow
        ...
        Public Property Stato() As String
            Get
                Try 
                    Return CType(Me(Me.tablePrenSale.StatoColumn),String)
                Catch e As Global.System.InvalidCastException
                    Throw New Global.System.Data.StrongTypingException("Il valore della colonna 'Stato' nella tabella 'PrenSale' è DBNull.", e)
                End Try
            End Get
            Set
                Me(Me.tablePrenSale.StatoColumn) = value
            End Set
        End Property
        ...
        Public Function IsStatoNull() As Boolean
            Return Me.IsNull(Me.tablePrenSale.StatoColumn)
        End Function
        
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         Global.System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")>  _
        Public Sub SetStatoNull()
            Me(Me.tablePrenSale.StatoColumn) = Global.System.Convert.DBNull
        End Sub
...
Namespace PrenSaleDataSetTableAdapters
    ...
    Partial Public Class PrenSaleTableAdapter
        ...
        Private Sub InitAdapter()
            ...
            tableMapping.DataSetTable = "PrenSale"
            ...
            Me._adapter.DeleteCommand.CommandText = "DELETE FROM `PrenSale` WHERE ((`Id` = ?) AND ((? = 1 AND `Data` IS NULL) OR (`Dat"& _ 
                "a` = ?)) AND ((? = 1 AND `IdRisorsa` IS NULL) OR (`IdRisorsa` = ?)) AND ((? = 1 "& _ 
                "AND `DescrizioneRisorsa` IS NULL) OR (`DescrizioneRisorsa` = ?)) AND ((? = 1 AND"& _ 
                " `Cliente` IS NULL) OR (`Cliente` = ?)) AND ((? = 1 AND `OraInizio` IS NULL) OR "& _ 
                "(`OraInizio` = ?)) AND ((? = 1 AND `OraFine` IS NULL) OR (`OraFine` = ?)) AND (("& _ 
                "? = 1 AND `Persone` IS NULL) OR (`Persone` = ?)) AND ((? = 1 AND `Stato` IS NULL"& _ 
                ") OR (`Stato` = ?)) AND ((? = 1 AND `Colore` IS NULL) OR (`Colore` = ?)))"
            ...
            Me._adapter.InsertCommand.CommandText = "INSERT INTO `PrenSale` (`Data`, `IdRisorsa`, `DescrizioneRisorsa`, `Cliente`, `Or"& _ 
                "aInizio`, `OraFine`, `Persone`, `Stato`, `Colore`, `Note`) VALUES (?, ?, ?, ?, ?"& _ 
                ", ?, ?, ?, ?, ?)"
            ...
            Me._adapter.UpdateCommand.CommandText = "UPDATE `PrenSale` SET `Data` = ?, `IdRisorsa` = ?, `DescrizioneRisorsa` = ?, `Cli"& _ 
                "ente` = ?, `OraInizio` = ?, `OraFine` = ?, `Persone` = ?, `Stato` = ?, `Colore` "& _ 
                "= ?, `Note` = ? WHERE ((`Id` = ?) AND ((? = 1 AND `Data` IS NULL) OR (`Data` = ?"& _ 
                ")) AND ((? = 1 AND `IdRisorsa` IS NULL) OR (`IdRisorsa` = ?)) AND ((? = 1 AND `D"& _ 
                "escrizioneRisorsa` IS NULL) OR (`DescrizioneRisorsa` = ?)) AND ((? = 1 AND `Clie"& _ 
                "nte` IS NULL) OR (`Cliente` = ?)) AND ((? = 1 AND `OraInizio` IS NULL) OR (`OraI"& _ 
                "nizio` = ?)) AND ((? = 1 AND `OraFine` IS NULL) OR (`OraFine` = ?)) AND ((? = 1 "& _ 
                "AND `Persone` IS NULL) OR (`Persone` = ?)) AND ((? = 1 AND `Stato` IS NULL) OR ("& _ 
                "`Stato` = ?)) AND ((? = 1 AND `Colore` IS NULL) OR (`Colore` = ?)))"
        ...
        Private Sub InitCommandCollection()
            ...
            Me._commandCollection(0).CommandText = "SELECT Id, Data, IdRisorsa, DescrizioneRisorsa, Cliente, OraInizio, OraFine, Pers"& _ 
                "one, Stato, Colore, [Note] FROM PrenSale"
        ...
        Public Overloads Overridable Function Fill(ByVal dataTable As PrenSaleDataSet.PrenSaleDataTable) As Integer
        ...
        Public Overloads Overridable Function GetData() As PrenSaleDataSet.PrenSaleDataTable
            Me.Adapter.SelectCommand = Me.CommandCollection(0)
            Dim dataTable As PrenSaleDataSet.PrenSaleDataTable = New PrenSaleDataSet.PrenSaleDataTable()
        ...
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         Global.System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0"),  _
         Global.System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")>  _
        Public Overloads Overridable Function Update(ByVal dataTable As PrenSaleDataSet.PrenSaleDataTable) As Integer
        ...
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         Global.System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0"),  _
         Global.System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")>  _
        Public Overloads Overridable Function Update(ByVal dataSet As PrenSaleDataSet) As Integer
            Return Me.Adapter.Update(dataSet, "PrenSale")
        End Function
        ...
        Public Overloads Overridable Function Delete(ByVal Original_Id As Integer, ByVal Original_Data As Date, ByVal Original_IdRisorsa As String, ByVal Original_DescrizioneRisorsa As String, ByVal Original_Cliente As String, ByVal Original_OraInizio As String, ByVal Original_OraFine As String, ByVal Original_Persone As String, ByVal Original_Stato As String, ByVal Original_Colore As String) As Integer
            ...
            Else
                ...
                Me.Adapter.DeleteCommand.Parameters(4).Value = CType(Original_IdRisorsa,String)
            End If
            ...
            Else
                ...
                Me.Adapter.DeleteCommand.Parameters(6).Value = CType(Original_DescrizioneRisorsa,String)
            End If
            ...
            Else
                ...
                Me.Adapter.DeleteCommand.Parameters(10).Value = CType(Original_OraInizio,String)
            End If
            If (Original_OraFine Is Nothing) Then
                Throw New Global.System.ArgumentNullException("Original_OraFine")
            Else
                Me.Adapter.DeleteCommand.Parameters(11).Value = CType(0,Object)
                Me.Adapter.DeleteCommand.Parameters(12).Value = CType(Original_OraFine,String)
            End If
            If (Original_Persone Is Nothing) Then
                Throw New Global.System.ArgumentNullException("Original_Persone")
            Else
                Me.Adapter.DeleteCommand.Parameters(13).Value = CType(0,Object)
                Me.Adapter.DeleteCommand.Parameters(14).Value = CType(Original_Persone,String)
            End If
            ...
            Else
                ...
                Me.Adapter.DeleteCommand.Parameters(16).Value = CType(Original_Stato,String)
            End If
            ...
            Else
                ...
                Me.Adapter.DeleteCommand.Parameters(18).Value = CType(Original_Colore,String)
            End If
        ...
        Public Overloads Overridable Function Insert(ByVal Data As Date, ByVal IdRisorsa As String, ByVal DescrizioneRisorsa As String, ByVal Cliente As String, ByVal OraInizio As String, ByVal OraFine As String, ByVal Persone As String, ByVal Stato As String, ByVal Colore As String, ByVal Note As String) As Integer
            Me.Adapter.InsertCommand.Parameters(0).Value = CType(Data,Date)
            If (IdRisorsa Is Nothing) Then
                Me.Adapter.InsertCommand.Parameters(1).Value = Global.System.DBNull.Value
            Else
                Me.Adapter.InsertCommand.Parameters(1).Value = CType(IdRisorsa,String)
            End If
            If (DescrizioneRisorsa Is Nothing) Then
                Throw New Global.System.ArgumentNullException("DescrizioneRisorsa")
            Else
                Me.Adapter.InsertCommand.Parameters(2).Value = CType(DescrizioneRisorsa,String)
            End If
            ...
            Else
                Me.Adapter.InsertCommand.Parameters(4).Value = CType(OraInizio,String)
            End If
            If (OraFine Is Nothing) Then
                Throw New Global.System.ArgumentNullException("OraFine")
            Else
                Me.Adapter.InsertCommand.Parameters(5).Value = CType(OraFine,String)
            End If
            If (Persone Is Nothing) Then
                Throw New Global.System.ArgumentNullException("Persone")
            Else
                Me.Adapter.InsertCommand.Parameters(6).Value = CType(Persone,String)
            End If
            If (Stato Is Nothing) Then
                Me.Adapter.InsertCommand.Parameters(7).Value = Global.System.DBNull.Value
            Else
                Me.Adapter.InsertCommand.Parameters(7).Value = CType(Stato,String)
            End If
            If (Colore Is Nothing) Then
                Me.Adapter.InsertCommand.Parameters(8).Value = Global.System.DBNull.Value
            Else
                Me.Adapter.InsertCommand.Parameters(8).Value = CType(Colore,String)
            End If
        ...
        Public Overloads Overridable Function Update( _
            ...
            Else
                Me.Adapter.UpdateCommand.Parameters(1).Value = CType(IdRisorsa,String)
            End If
            If (DescrizioneRisorsa Is Nothing) Then
                Throw New Global.System.ArgumentNullException("DescrizioneRisorsa")
            Else
                Me.Adapter.UpdateCommand.Parameters(2).Value = CType(DescrizioneRisorsa,String)
            End If
            If (Cliente Is Nothing) Then
                Throw New Global.System.ArgumentNullException("Cliente")
            Else
            ...
            If (OraInizio Is Nothing) Then
                Throw New Global.System.ArgumentNullException("OraInizio")
            Else
                Me.Adapter.UpdateCommand.Parameters(4).Value = CType(OraInizio,String)
            End If
            If (OraFine Is Nothing) Then
                Throw New Global.System.ArgumentNullException("OraFine")
            Else
                Me.Adapter.UpdateCommand.Parameters(5).Value = CType(OraFine,String)
            End If
            If (Persone Is Nothing) Then
                Throw New Global.System.ArgumentNullException("Persone")
            Else
                Me.Adapter.UpdateCommand.Parameters(6).Value = CType(Persone,String)
            End If
            If (Stato Is Nothing) Then
                Me.Adapter.UpdateCommand.Parameters(7).Value = Global.System.DBNull.Value
            Else
                Me.Adapter.UpdateCommand.Parameters(7).Value = CType(Stato,String)
            End If
            If (Colore Is Nothing) Then
                Me.Adapter.UpdateCommand.Parameters(8).Value = Global.System.DBNull.Value
            Else
                Me.Adapter.UpdateCommand.Parameters(8).Value = CType(Colore,String)
            End If
            If (Note Is Nothing) Then
            ...
            Else
                ...
                Me.Adapter.UpdateCommand.Parameters(14).Value = CType(Original_IdRisorsa,String)
            End If
            If (Original_DescrizioneRisorsa Is Nothing) Then
                Throw New Global.System.ArgumentNullException("Original_DescrizioneRisorsa")
            Else
                Me.Adapter.UpdateCommand.Parameters(15).Value = CType(0,Object)
                Me.Adapter.UpdateCommand.Parameters(16).Value = CType(Original_DescrizioneRisorsa,String)
            End If
            If (Original_Cliente Is Nothing) Then
                Throw New Global.System.ArgumentNullException("Original_Cliente")
            Else
            ...
            Else
                ...
                Me.Adapter.UpdateCommand.Parameters(20).Value = CType(Original_OraInizio,String)
            End If
            If (Original_OraFine Is Nothing) Then
                Throw New Global.System.ArgumentNullException("Original_OraFine")
            Else
                Me.Adapter.UpdateCommand.Parameters(21).Value = CType(0,Object)
                Me.Adapter.UpdateCommand.Parameters(22).Value = CType(Original_OraFine,String)
            End If
            If (Original_Persone Is Nothing) Then
                Throw New Global.System.ArgumentNullException("Original_Persone")
            Else
                Me.Adapter.UpdateCommand.Parameters(23).Value = CType(0,Object)
                Me.Adapter.UpdateCommand.Parameters(24).Value = CType(Original_Persone,String)
            End If
            If (Original_Stato Is Nothing) Then
            ...
            Else
                ...
                Me.Adapter.UpdateCommand.Parameters(26).Value = CType(Original_Stato,String)
            End If
            If (Original_Colore Is Nothing) Then
            ...
            Else
                ...
                Me.Adapter.UpdateCommand.Parameters(28).Value = CType(Original_Colore,String)
            End If
    ...
    Partial Public Class TableAdapterManager
        ...
        Private _prenSaleTableAdapter As PrenSaleTableAdapter
        ...
        Public Property PrenSaleTableAdapter() As PrenSaleTableAdapter
            Get
                Return Me._prenSaleTableAdapter
            End Get
            Set
                Me._prenSaleTableAdapter = value
            End Set
        End Property
        ...
        Public Property Connection() As Global.System.Data.IDbConnection
            Get
                If (Not (Me._connection) Is Nothing) Then
                    Return Me._connection
                End If
                If ((Not (Me._prenSaleTableAdapter) Is Nothing)  _
                            AndAlso (Not (Me._prenSaleTableAdapter.Connection) Is Nothing)) Then
                    Return Me._prenSaleTableAdapter.Connection
                End If
                Return Nothing
            End Get
            Set
        ...
        Public ReadOnly Property TableAdapterInstanceCount() As Integer
            Get
                ...
                If (Not (Me._prenSaleTableAdapter) Is Nothing) Then
                    count = (count + 1)
                End If
                Return count
            End Get
        ...
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         Global.System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")>  _
        Private Function UpdateUpdatedRows(ByVal dataSet As PrenSaleDataSet, ByVal allChangedRows As Global.System.Collections.Generic.List(Of Global.System.Data.DataRow), ByVal allAddedRows As Global.System.Collections.Generic.List(Of Global.System.Data.DataRow)) As Integer
            Dim result As Integer = 0
            If (Not (Me._prenSaleTableAdapter) Is Nothing) Then
                Dim updatedRows() As Global.System.Data.DataRow = dataSet.PrenSale.Select(Nothing, Nothing, Global.System.Data.DataViewRowState.ModifiedCurrent)
                updatedRows = Me.GetRealUpdatedRows(updatedRows, allAddedRows)
                If ((Not (updatedRows) Is Nothing)  _
                            AndAlso (0 < updatedRows.Length)) Then
                    result = (result + Me._prenSaleTableAdapter.Update(updatedRows))
        ...
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         Global.System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")>  _
        Private Function UpdateInsertedRows(ByVal dataSet As PrenSaleDataSet, ByVal allAddedRows As Global.System.Collections.Generic.List(Of Global.System.Data.DataRow)) As Integer
            Dim result As Integer = 0
            If (Not (Me._prenSaleTableAdapter) Is Nothing) Then
                Dim addedRows() As Global.System.Data.DataRow = dataSet.PrenSale.Select(Nothing, Nothing, Global.System.Data.DataViewRowState.Added)
                If ((Not (addedRows) Is Nothing)  _
                            AndAlso (0 < addedRows.Length)) Then
                    result = (result + Me._prenSaleTableAdapter.Update(addedRows))
        ...
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         Global.System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")>  _
        Private Function UpdateDeletedRows(ByVal dataSet As PrenSaleDataSet, ByVal allChangedRows As Global.System.Collections.Generic.List(Of Global.System.Data.DataRow)) As Integer
            Dim result As Integer = 0
            If (Not (Me._prenSaleTableAdapter) Is Nothing) Then
                Dim deletedRows() As Global.System.Data.DataRow = dataSet.PrenSale.Select(Nothing, Nothing, Global.System.Data.DataViewRowState.Deleted)
                If ((Not (deletedRows) Is Nothing)  _
                            AndAlso (0 < deletedRows.Length)) Then
                    result = (result + Me._prenSaleTableAdapter.Update(deletedRows))
        ...
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         Global.System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")>  _
        Public Overridable Function UpdateAll(ByVal dataSet As PrenSaleDataSet) As Integer
            ...
            End If
            If ((Not (Me._prenSaleTableAdapter) Is Nothing)  _
                        AndAlso (Me.MatchTableAdapterConnection(Me._prenSaleTableAdapter.Connection) = false)) Then
            ...
            Try 
                ...
                '
                If (Not (Me._prenSaleTableAdapter) Is Nothing) Then
                    revertConnections.Add(Me._prenSaleTableAdapter, Me._prenSaleTableAdapter.Connection)
                    Me._prenSaleTableAdapter.Connection = CType(workConnection,Global.System.Data.OleDb.OleDbConnection)
                    Me._prenSaleTableAdapter.Transaction = CType(workTransaction,Global.System.Data.OleDb.OleDbTransaction)
                    If Me._prenSaleTableAdapter.Adapter.AcceptChangesDuringUpdate Then
                        Me._prenSaleTableAdapter.Adapter.AcceptChangesDuringUpdate = false
                        adaptersWithAcceptChangesDuringUpdate.Add(Me._prenSaleTableAdapter.Adapter)
                    End If
                End If
                '
                '---- Perform updates -----------
            ...
            Finally
                ...
                End If
                If (Not (Me._prenSaleTableAdapter) Is Nothing) Then
                    Me._prenSaleTableAdapter.Connection = CType(revertConnections(Me._prenSaleTableAdapter),Global.System.Data.OleDb.OleDbConnection)
                    Me._prenSaleTableAdapter.Transaction = Nothing
                End If
