...
Public Class RepSale
   ...
   Public Sub New(ByVal ds As SaleDataSet, ByVal nomeDoc As String, ByVal percorsoNomeStampante As String)
      Try
         ...
         Me.SaleBindingSource.DataSource = ds
   ...
   Private Sub RepSale_Load(sender As Object, e As EventArgs) Handles MyBase.Load
      Try
         ' Imposta l'icona della finestra in base al prodotto installato.
         ImpostaIcona(Me)

         ' Carica i dati delle rispettive tabelle.
         Me.SaleTableAdapter.Fill(Me.SaleDataSet.Sale)
