...
Public Class RepNoleggi
   Dim nomeStampante As String
   Dim nomeReport As String

   Public Sub New(ByVal ds As NoleggiDataSet, ByVal nomeDoc As String, ByVal percorsoNomeStampante As String)
      Try
         ...
         Me.NoleggiBindingSource.DataSource = ds
   ...
   Private Sub RepNoleggi_Load(sender As Object, e As EventArgs) Handles MyBase.Load
      Try
         ' Imposta l'icona della finestra in base al prodotto installato.
         ImpostaIcona(Me)

         ' Carica i dati delle rispettive tabelle.
         Me.NoleggiTableAdapter.Fill(Me.NoleggiDataSet.Noleggi)
