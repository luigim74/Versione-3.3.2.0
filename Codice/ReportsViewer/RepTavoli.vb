...
Public Class RepTavoli
   Dim nomeStampante As String
   Dim nomeReport As String

   Public Sub New(ByVal ds As TavoliDataSet, ByVal nomeDoc As String, ByVal percorsoNomeStampante As String)
      Try
         ...
         Me.TavoliBindingSource.DataSource = ds
   ...
   Private Sub RepTavoli_Load(sender As Object, e As EventArgs) Handles MyBase.Load
      Try
         ' Imposta l'icona della finestra in base al prodotto installato.
         ImpostaIcona(Me)

         ' Carica i dati delle rispettive tabelle.
         Me.TavoliTableAdapter.Fill(Me.TavoliDataSet.Tavoli)
