...
Public Class RepFornitori
   Dim nomeStampante As String
   Dim nomeReport As String

   Public Sub New(ByVal ds As FornitoriDataSet, ByVal nomeDoc As String, ByVal percorsoNomeStampante As String)
      Try
         ...
         Me.FornitoriBindingSource.DataSource = ds
   ...
   Private Sub RepFornitori_Load(sender As Object, e As EventArgs) Handles MyBase.Load
      Try
