...
Public Class RepOperatori
   Dim nomeStampante As String
   Dim nomeReport As String

   Public Sub New(ByVal ds As OperatoriDataSet, ByVal nomeDoc As String, ByVal percorsoNomeStampante As String)
      Try
         ...
         Me.OperatoriBindingSource.DataSource = ds
   ...
   Private Sub RepOperatori_Load(sender As Object, e As EventArgs) Handles MyBase.Load
      Try
         ' Imposta l'icona della finestra in base al prodotto installato.
         ImpostaIcona(Me)

         ' Carica i dati delle rispettive tabelle.
         Me.OperatoriTableAdapter.Fill(Me.OperatoriDataSet.Operatori)
