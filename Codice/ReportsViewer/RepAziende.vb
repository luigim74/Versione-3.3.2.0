...
Public Class RepAziende
   Dim nomeStampante As String
   Dim nomeReport As String

   Public Sub New(ByVal ds As AziendeDataSet, ByVal nomeDoc As String, ByVal percorsoNomeStampante As String)
      Try
         ...
         Me.AziendeBindingSource.DataSource = ds
   ...
   Private Sub RepAziende_Load(sender As Object, e As EventArgs) Handles MyBase.Load
      Try
         ' Imposta l'icona della finestra in base al prodotto installato.
         ImpostaIcona(Me)

         ' Carica i dati delle rispettive tabelle.
         Me.AziendeTableAdapter.Fill(Me.AziendeDataSet.Aziende)
