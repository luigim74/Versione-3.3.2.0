...
Public Class RepStatisticheBarRistorante
   Dim nomeStampante As String
   Dim nomeReport As String

   Public Sub New(ByVal ds As StatisticheBarRistoranteDataSet, ByVal nomeDoc As String, ByVal percorsoNomeStampante As String)
      Try
         ...
         Me.StatisticheBindingSource.DataSource = ds
   ...
   Private Sub RepStatisticheBarRistorante_Load(sender As Object, e As EventArgs) Handles MyBase.Load
      Try
         ' Imposta l'icona della finestra in base al prodotto installato.
         ImpostaIcona(Me)

         ' Carica i dati delle rispettive tabelle.
         Me.StatisticheTableAdapter.Fill(Me.StatisticheBarRistoranteDataSet.Statistiche)
