...
' Data ultima modifica: 17/01/2020
...
Public Class RepCategoriePiatti
   Dim nomeStampante As String
   Dim nomeReport As String

   Public Sub New(ByVal ds As CategoriePiattiDataSet, ByVal nomeDoc As String, ByVal percorsoNomeStampante As String)
      Try
         ...
         Me.CategoriePiattiBindingSource.DataSource = ds
   ...
   Private Sub RepCategoriePiatti_Load(sender As Object, e As EventArgs) Handles MyBase.Load
      Try
         ' Imposta l'icona della finestra in base al prodotto installato.
         ImpostaIcona(Me)

         ' Carica i dati delle rispettive tabelle.
         Me.CategoriePiattiTableAdapter.Fill(Me.CategoriePiattiDataSet.CategoriePiatti)
