...
Public Class RepPrenTavoli
   Dim nomeStampante As String
   Dim nomeReport As String

   Public Sub New(ByVal ds As PrenTavoliDataSet, ByVal nomeDoc As String, ByVal percorsoNomeStampante As String)
      Try
         ...
         Me.PrenotazioniBindingSource.DataSource = ds
   ...
   Private Sub RepPrenTavoli_Load(sender As Object, e As EventArgs) Handles MyBase.Load
      Try
         ' Imposta l'icona della finestra in base al prodotto installato.
         ImpostaIcona(Me)

         ' Carica i dati delle rispettive tabelle.
         Me.PrenotazioniTableAdapter.Fill(Me.PrenTavoliDataSet.Prenotazioni)
