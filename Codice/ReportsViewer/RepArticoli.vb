...
Public Class RepArticoli
   Dim nomeStampante As String
   Dim nomeReport As String

   Public Sub New(ByVal ds As ArticoliDataSet, ByVal nomeDoc As String, ByVal percorsoNomeStampante As String)
      Try
   ...
   Private Sub RepArticoli_Load(sender As Object, e As EventArgs) Handles MyBase.Load
      Try
         ' Imposta l'icona della finestra in base al prodotto installato.
         ImpostaIcona(Me)

         ' Carica i dati delle rispettive tabelle.
         Me.ArticoliTableAdapter.Fill(Me.ArticoliDataSet.Articoli)
