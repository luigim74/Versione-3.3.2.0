...
Public Class RepPrenSale
   Dim nomeStampante As String
   Dim nomeReport As String

   Public Sub New(ByVal ds As PrenSaleDataSet, ByVal nomeDoc As String, ByVal percorsoNomeStampante As String)
      Try
         ...
         Me.PrenSaleBindingSource.DataSource = ds
   ...
   Private Sub RepPrenSale_Load(sender As Object, e As EventArgs) Handles MyBase.Load
      Try
         ' Imposta l'icona della finestra in base al prodotto installato.
         ImpostaIcona(Me)

         ' Carica i dati delle rispettive tabelle.
         Me.PrenSaleTableAdapter.Fill(Me.PrenSaleDataSet.PrenSale)
