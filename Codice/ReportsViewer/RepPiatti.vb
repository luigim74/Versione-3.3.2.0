...
Public Class RepPiatti
   Dim nomeStampante As String
   Dim nomeReport As String

   Public Sub New(ByVal ds As PiattiDataSet, ByVal nomeDoc As String, ByVal percorsoNomeStampante As String)
      Try
   ...
   Private Sub RepPiatti_Load(sender As Object, e As EventArgs) Handles MyBase.Load
      Try
         ' Imposta l'icona della finestra in base al prodotto installato.
         ImpostaIcona(Me)

         ' Carica i dati delle rispettive tabelle.
         Me.PiattiTableAdapter.Fill(Me.PiattiDataSet.Piatti)
