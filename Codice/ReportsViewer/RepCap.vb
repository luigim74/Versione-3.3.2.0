...
' Data creazione:       04/09/2018
' Data ultima modifica: 04/09/2018
...
Public Class RepCap
   ...
   Public Sub New(ByVal ds As HospitalityDataSet, ByVal nomeDoc As String, ByVal percorsoNomeStampante As String)
      Try
         ...
         Me.CAPBindingSource.DataSource = ds
   ...
   Private Sub RepCap_Load(sender As Object, e As EventArgs) Handles MyBase.Load
      Try
         ' Imposta l'icona della finestra in base al prodotto installato.
         ImpostaIcona(Me)

         ' Carica i dati delle rispettive tabelle.
         Me.CAPTableAdapter.Fill(Me.HospitalityDataSet.CAP)
