...
' Data creazione:       27/06/2020
' Data ultima modifica: 27/06/2020
...
Public Class RepScontiMaggiorazioni
   Dim nomeStampante As String
   Dim nomeReport As String

   Public Sub New(ByVal ds As ScontiMaggiorazioniDataSet, ByVal nomeDoc As String, ByVal percorsoNomeStampante As String)
      Try
         ...
         Me.ScontiMaggiorazioniBindingSource.DataSource = ds
   ...
   Private Sub RepScontiMaggiorazioni_Load(sender As Object, e As EventArgs) Handles MyBase.Load
      Try
         ' Imposta l'icona della finestra in base al prodotto installato.
         ImpostaIcona(Me)

         ' Carica i dati delle rispettive tabelle.
         Me.ScontiMaggiorazioniTableAdapter.Fill(Me.ScontiMaggiorazioniDataSet.ScontiMaggiorazioni)
