...
Public Class RepCorrispettivi
   Dim nomeStampante As String
   Dim nomeReport As String

   Public Sub New(ByVal ds As CorrispettiviDataSet, ByVal nomeDoc As String, ByVal percorsoNomeStampante As String)
      Try
         ...
         Me.CorrispettiviBindingSource.DataSource = ds
   ...
   Private Sub RepCorrispettivi_Load(sender As Object, e As EventArgs) Handles MyBase.Load
      Try
         ' Imposta l'icona della finestra in base al prodotto installato.
         ImpostaIcona(Me)

         ' Carica i dati delle rispettive tabelle.
         Me.CorrispettiviTableAdapter.Fill(Me.CorrispettiviDataSet.Corrispettivi)
