...
Public Class RepMovMagazzino
   Dim nomeStampante As String
   Dim nomeReport As String

   Public Sub New(ByVal ds As MovMagazzinoDataSet, ByVal nomeDoc As String, ByVal percorsoNomeStampante As String)
      Try
         ...
         Me.MovMagazzinoBindingSource.DataSource = ds
   ...
   Private Sub RepMovMagazzino_Load(sender As Object, e As EventArgs) Handles MyBase.Load
      Try
         ' Imposta l'icona della finestra in base al prodotto installato.
         ImpostaIcona(Me)

         ' Carica i dati delle rispettive tabelle.
         Me.MovMagazzinoTableAdapter.Fill(Me.MovMagazzinoDataSet.MovMagazzino)
