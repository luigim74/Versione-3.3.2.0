...
Public Class RepRisorseSportive
   Dim nomeStampante As String
   Dim nomeReport As String

   Public Sub New(ByVal ds As RisorseSportiveDataSet, ByVal nomeDoc As String, ByVal percorsoNomeStampante As String)
      Try
         ...
         Me.RisorseBindingSource.DataSource = ds
   ...
   Private Sub RepRisorseSportive_Load(sender As Object, e As EventArgs) Handles MyBase.Load
      Try
         ' Imposta l'icona della finestra in base al prodotto installato.
         ImpostaIcona(Me)

         ' Carica i dati delle rispettive tabelle.
         Me.RisorseTableAdapter.Fill(Me.RisorseSportiveDataSet.Risorse)
