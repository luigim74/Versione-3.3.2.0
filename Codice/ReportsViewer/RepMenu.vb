...
' Data creazione:       01/11/2020
' Data ultima modifica: 01/11/2020
...
Public Class RepMenu
   ...
   Public Sub New(ByVal ds As MenuDataSet, ByVal nomeDoc As String, ByVal percorsoNomeStampante As String)
      Try
         ...
         Me.ReportViewer1.LocalReport.ReportPath = nomeDoc

         Me.FormazioneMenuBindingSource.DataMember = "FormazioneMenu"
         Me.FormazioneMenuBindingSource.DataSource = ds

         Me.PiattiBindingSource.DataMember = "Piatti"
         Me.PiattiBindingSource.DataSource = ds
   ...
   Private Sub RepMenu_Load(sender As Object, e As EventArgs) Handles MyBase.Load
      Try
         ' Imposta l'icona della finestra in base al prodotto installato.
         ImpostaIcona(Me)

         ' Carica i dati delle rispettive tabelle.
         Me.FormazioneMenuTableAdapter.Fill(Me.MenuDataSet.FormazioneMenu)
         Me.PiattiTableAdapter.Fill(Me.MenuDataSet.Piatti)
