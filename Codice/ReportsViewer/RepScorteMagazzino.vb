...
' Data creazione:       21/01/2020
' Data ultima modifica: 21/01/2020
...
Public Class RepScorteMagazzino
   Dim nomeStampante As String
   Dim nomeReport As String

   Public Sub New(ByVal ds As ScorteMagazzinoDataSet, ByVal nomeDoc As String, ByVal percorsoNomeStampante As String)
      Try
   ...
   Private Sub RepScorteMagazzino_Load(sender As Object, e As EventArgs) Handles MyBase.Load
      Try
         ' Imposta l'icona della finestra in base al prodotto installato.
         ImpostaIcona(Me)

         ' Carica i dati delle rispettive tabelle.
         Me.ArticoliTableAdapter.Fill(Me.ScorteMagazzinoDataSet.Articoli)
