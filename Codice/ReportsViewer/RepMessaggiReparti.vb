...
' Data ultima modifica: 30/03/2020
...
Public Class RepMessaggiReparti
   ...
   Public Sub New(ByVal ds As MessaggiRepartiDataSet, ByVal nomeDoc As String, ByVal percorsoNomeStampante As String)
      Try
         ...
         Me.MessaggiBindingSource.DataSource = ds
   ...
   Private Sub RepMessaggiReparti_Load(sender As Object, e As EventArgs) Handles MyBase.Load
      Try
         ' Imposta l'icona della finestra in base al prodotto installato.
         ImpostaIcona(Me)

         ' Carica i dati delle rispettive tabelle.
         Me.MessaggiTableAdapter.Fill(Me.MessaggiRepartiDataSet.Messaggi)
