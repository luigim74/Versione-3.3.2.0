...
' Data creazione:       18/01/2020
' Data ultima modifica: 18/01/2020
...
Public Class RepOperazioni
   Dim nomeStampante As String
   Dim nomeReport As String

   Public Sub New(ByVal ds As OperazioniDataSet, ByVal nomeDoc As String, ByVal percorsoNomeStampante As String)
      Try
         ...
         Me.OperazioniBindingSource.DataSource = ds
   ...
   Private Sub Operazioni_Load(sender As Object, e As EventArgs) Handles MyBase.Load
      Try
         ' Imposta l'icona della finestra in base al prodotto installato.
         ImpostaIcona(Me)

         ' Carica i dati delle rispettive tabelle.
         Me.OperazioniTableAdapter.Fill(Me.OperazioniDataSet.Operazioni)
