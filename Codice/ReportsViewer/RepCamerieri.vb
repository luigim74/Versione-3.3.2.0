...
Public Class RepCamerieri
   Dim nomeStampante As String
   Dim nomeReport As String

   Public Sub New(ByVal ds As CamerieriDataSet, ByVal nomeDoc As String, ByVal percorsoNomeStampante As String)
      Try
         ...
         Me.CamerieriBindingSource.DataSource = ds
   ...
   Private Sub RepCamerieri_Load(sender As Object, e As EventArgs) Handles MyBase.Load
      Try
         ' Imposta l'icona della finestra in base al prodotto installato.
         ImpostaIcona(Me)

         ' Carica i dati delle rispettive tabelle.
         Me.CamerieriTableAdapter.Fill(Me.CamerieriDataSet.Camerieri)
