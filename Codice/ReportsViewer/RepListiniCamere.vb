...
Public Class RepListiniCamere
   ...
   Public Sub New(ByVal ds As HospitalityDataSet, ByVal nomeDoc As String, ByVal percorsoNomeStampante As String)
      Try
         ...
         Me.ListiniCamereBindingSource.DataSource = ds
   ...
   Private Sub RepListiniCamere_Load(sender As Object, e As EventArgs) Handles MyBase.Load
      Try
         ' Imposta l'icona della finestra in base al prodotto installato.
         ImpostaIcona(Me)

         ' Carica i dati delle rispettive tabelle.
         Me.ListiniCamereTableAdapter.Fill(Me.HospitalityDataSet.ListiniCamere)
