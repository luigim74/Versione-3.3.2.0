...
Public Class RepPrimaNota
   Dim nomeStampante As String
   Dim nomeReport As String

   Public Sub New(ByVal ds As PrimaNotaDataSet, ByVal nomeDoc As String, ByVal percorsoNomeStampante As String)
      Try
         ...
         Me.PrimaNotaBindingSource.DataSource = ds
   ...
   Private Sub RepPrimaNota_Load(sender As Object, e As EventArgs) Handles MyBase.Load
      Try
         ' Imposta l'icona della finestra in base al prodotto installato.
         ImpostaIcona(Me)

         ' Carica i dati delle rispettive tabelle.
         Me.PrimaNotaTableAdapter.Fill(Me.PrimaNotaDataSet.PrimaNota)
