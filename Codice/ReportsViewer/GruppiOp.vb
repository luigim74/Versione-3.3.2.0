...
Public Class RepGruppiOp
   Dim nomeStampante As String
   Dim nomeReport As String

   Public Sub New(ByVal ds As GruppiOpDataSet, ByVal nomeDoc As String, ByVal percorsoNomeStampante As String)
      Try
         ...
         Me.GruppiBindingSource.DataSource = ds
   ...
   Private Sub RepGruppiOp_Load(sender As Object, e As EventArgs) Handles MyBase.Load
      Try
         ' Imposta l'icona della finestra in base al prodotto installato.
         ImpostaIcona(Me)

         ' Carica i dati delle rispettive tabelle.
         Me.GruppiTableAdapter.Fill(Me.GruppiOpDataSet.Gruppi)
