...
' Data creazione:       19/01/2020
' Data ultima modifica: 19/01/2020
...
Public Class RepPrenRisorseSportive
   Dim nomeStampante As String
   Dim nomeReport As String

   Public Sub New(ByVal ds As PrenRisorseSportiveDataSet, ByVal nomeDoc As String, ByVal percorsoNomeStampante As String)
      Try
         ...
         Me.PrenRisorseBindingSource.DataSource = ds
   ...
   Private Sub RepPrenRisorseSportive_Load(sender As Object, e As EventArgs) Handles MyBase.Load
      Try
         ' Imposta l'icona della finestra in base al prodotto installato.
         ImpostaIcona(Me)

         ' Carica i dati delle rispettive tabelle.
         Me.PrenRisorseTableAdapter.Fill(Me.PrenRisorseSportiveDataSet.PrenRisorse)
