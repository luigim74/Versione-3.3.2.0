...
' Data creazione:       29/03/2020
' Data ultima modifica: 29/03/2020
...
Public Class RepStatisticheCentroSportivo
   Dim nomeStampante As String
   Dim nomeReport As String

   Public Sub New(ByVal ds As StatisticheCentroSportivoDataSet, ByVal nomeDoc As String, ByVal percorsoNomeStampante As String)
      Try
         ...
         Me.StatisticheRisorseBindingSource.DataSource = ds
   ...
   Private Sub RepStatisticheCentroSportivo_Load(sender As Object, e As EventArgs) Handles MyBase.Load
      Try
         ' Imposta l'icona della finestra in base al prodotto installato.
         ImpostaIcona(Me)

         ' Carica i dati delle rispettive tabelle.
         Me.StatisticheRisorseTableAdapter.Fill(Me.StatisticheCentroSportivoDataSet.StatisticheRisorse)
