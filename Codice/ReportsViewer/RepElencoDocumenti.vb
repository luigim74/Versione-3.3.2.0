...
Public Class RepElencoDocumenti
   Dim nomeStampante As String
   Dim nomeReport As String

   Public Sub New(ByVal ds As DocumentiDataSet, ByVal nomeDoc As String, ByVal percorsoNomeStampante As String)
      Try
   ...
   Private Sub RepElencoDocumenti_Load(sender As Object, e As EventArgs) Handles MyBase.Load
      Try
         ' Imposta l'icona della finestra in base al prodotto installato.
         ImpostaIcona(Me)

         ' Carica i dati delle rispettive tabelle.
         Me.DocumentiTableAdapter.Fill(Me.DocumentiDataSet.Documenti)
