...
Public Class DettagliNoleggi
   ...
   Public Sub LeggiDati(ByVal tabella As String, ByVal codice As String)
      ...
      Try
         ...
         End If
         If IsDBNull(ds.Tables(tabella).Rows(0)("RifNoleggio")) = False Then
   ...
   Public Function EliminaDati(ByVal tabella As String, ByVal RifNoleggio As String) As Boolean
      Dim sql As String
      ...
      Try
         ...
         sql = String.Format("DELETE FROM {0} WHERE RifNoleggio = {1}", tabella, RifNoleggio)
