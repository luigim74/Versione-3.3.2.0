...
Public Class ContiTavoli
   ...
   Public Sub LeggiCodiceCliente(ByVal tabella As String, ByVal idTavolo As String)
      ' Dichiara un oggetto DataAdapter.
      Dim da As OleDbDataAdapter
      ' Dichiara un oggetto DataSet
      Dim ds As DataSet
      ...
      Try
         ...
         ' Crea la stringa.
         sql = String.Format("SELECT * FROM {0} WHERE IdTavolo = '{1}'", tabella, idTavolo)
   ...
   Public Function InserisciDati(ByVal tabella As String) As Boolean
      ...
      Try
         ...
         sql = String.Format("INSERT INTO {0} (IdTavolo, IdCliente, IdAzienda, Intestatario, Indirizzo, Cap, Città, Provincia, Piva, Iva, Sconto) " &
