...
#End Region
   ...
   Public Sub AggIntGriglia()
      Try
         If numRecord <> 0 Then
            DataGrid1.CaptionText = Strings.UCase("Piatto:  " & DataGrid1.Item(DataGrid1.CurrentCell.RowNumber, 1)) & _
                                                  " - ( Costo di produzione della ricetta: Ä " & _
                                                  CalcolaCostoPiatto("Articoli", CStr(DataGrid1.Item(DataGrid1.CurrentCell.RowNumber, 0))) & " )"
         Else
   ...
   Public Function CalcolaCostoPiatto(ByVal tabella As String, ByVal idPiatto As String) As Double
      ' Dichiara un oggetto connessione.
      Dim cn As New OleDbConnection(ConnString)
      Dim numRec As Integer
      ...
      Try
         ...
         Return CFormatta.FormattaNumeroDouble(costoPiatto)
   ...
   Private Sub frmElencoPiatti_Closed(ByVal sender As Object, ByVal e As System.EventArgs) Handles MyBase.Closed
      Try
         SalvaDatiConfig()
