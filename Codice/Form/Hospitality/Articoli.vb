...
#Region " Windows Form Designer generated code "
   ...
   <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
      ...
      Me.cmdElimina.Location = New System.Drawing.Point(296, 256)
      ...
      Me.cmdApri.Location = New System.Drawing.Point(208, 256)
      ...
      Me.picFoto.Location = New System.Drawing.Point(146, 11)
      Me.picFoto.Name = "picFoto"
      Me.picFoto.Size = New System.Drawing.Size(240, 236)
...
#Region "Procedure "
   ...
   Private Sub CalcolaProgressivi()
      If txtPrezzoAcquisto.Text <> "" Then

         If IsNumeric(txtPrezzoAcquisto.Text) = True Then

            If txtTotCarichi.Text <> "0" Then
               txtValCarichi.Text = CFormatta.FormattaEuro(CalcolaValore(CDec(txtPrezzoAcquisto.Text), CDec(txtTotCarichi.Text)))
            Else
               txtValCarichi.Text = VALORE_ZERO
            End If

            If txtTotScarichi.Text <> "0" Then
               txtValScarichi.Text = CFormatta.FormattaEuro(CalcolaValore(CDec(txtPrezzoAcquisto.Text), CDec(txtTotScarichi.Text)))
            Else
               txtValScarichi.Text = VALORE_ZERO
            End If

            If txtGiacenza.Text <> "0" Then
               txtValAttuale.Text = CFormatta.FormattaEuro(CalcolaValore(CDec(txtPrezzoAcquisto.Text), CDec(txtGiacenza.Text)))
            Else
               txtValAttuale.Text = VALORE_ZERO
            End If
      ...
      Try
         With AArticoli
            ...
            If IsNumeric(txtGiacenza.Text) Then
               .Giacenza = CFormatta.FormattaEuro(txtGiacenza.Text)
            Else
               .Giacenza = 0
            End If
            If IsNumeric(txtTotCarichi.Text) Then
               .Carico = CFormatta.FormattaEuro(txtTotCarichi.Text)
            Else
               .Carico = 0
            End If
            If IsNumeric(txtTotScarichi.Text) Then
               .Scarico = CFormatta.FormattaEuro(txtTotScarichi.Text)
            Else
               .Scarico = 0
            End If
            If IsNumeric(txtScortaMinima.Text) Then
               .ScortaMin = CFormatta.FormattaEuro(txtScortaMinima.Text)
            Else
               .ScortaMin = 0
            End If
            If IsNumeric(txtValCarichi.Text) Then
               .ValCarico = CFormatta.FormattaEuro(txtValCarichi.Text)
            Else
               .ValCarico = VALORE_ZERO
            End If
            If IsNumeric(txtValScarichi.Text) Then
               .ValScarico = CFormatta.FormattaEuro(txtValScarichi.Text)
            Else
               .ValScarico = VALORE_ZERO
            End If
            If IsNumeric(txtValAttuale.Text) Then
               .ValAttuale = CFormatta.FormattaEuro(txtValAttuale.Text)
            Else
      ...
      Try
         ...
         If Me.Tag <> "" Then
            With AArticoli
               ...
               txtGiacenza.Text = CFormatta.FormattaEuro(.Giacenza)
               txtTotCarichi.Text = CFormatta.FormattaEuro(.Carico)
               txtTotScarichi.Text = CFormatta.FormattaEuro(.Scarico)
               txtScortaMinima.Text = CFormatta.FormattaEuro(.ScortaMin)
               txtValCarichi.Text = CFormatta.FormattaEuro(.ValCarico)
               txtValScarichi.Text = CFormatta.FormattaEuro(.ValScarico)
               txtValAttuale.Text = CFormatta.FormattaEuro(.ValAttuale)
