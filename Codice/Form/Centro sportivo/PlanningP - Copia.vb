...
Public Class frmPlanningP2
   Inherits System.Windows.Forms.Form

   Public Const NUM_ORE As Short = 32
...
#Region " Codice generato da Progettazione Windows Form "
   ...
   <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
      ...
      Me.Panel3.Size = New System.Drawing.Size(1160, 19)
      ...
      Me.ToolBar2.Size = New System.Drawing.Size(1160, 26)
      ...
      Me.Panel4.Size = New System.Drawing.Size(1160, 70)
      ...
      Me.ckbVisCosto.Location = New System.Drawing.Point(680, 32)
      ...
      Me.Label9.Location = New System.Drawing.Point(1064, 13)
      ...
      Me.Label8.Location = New System.Drawing.Point(600, 13)
      ...
      Me.Larghezza.Location = New System.Drawing.Point(1064, 32)
      ...
      Me.Altezza.Location = New System.Drawing.Point(600, 32)
      ...
      'lblDettagliPren
      '
      Me.lblDettagliPren.AutoSize = True
      ...
      Me.lblDettagliPren.Location = New System.Drawing.Point(15, 40)
      Me.lblDettagliPren.Name = "lblDettagliPren"
      Me.lblDettagliPren.Size = New System.Drawing.Size(16, 16)
      Me.lblDettagliPren.TabIndex = 9
      Me.lblDettagliPren.Text = "#"
      '
      'lblRisorsaOra
      '
      Me.lblRisorsaOra.AutoSize = True
      ...
      Me.lblRisorsaOra.Size = New System.Drawing.Size(17, 18)
      Me.lblRisorsaOra.TabIndex = 8
      Me.lblRisorsaOra.Text = "#"
      '
      'Label7
      '
      ...
      Me.Label7.Location = New System.Drawing.Point(864, 13)
      ...
      Me.dtpData.Location = New System.Drawing.Point(864, 32)
      ...
      Me.Panel1.Size = New System.Drawing.Size(1080, 336)
      ...
      Me.Risorse.Size = New System.Drawing.Size(10360, 33)
      ...
      Me.HScrollBar1.Location = New System.Drawing.Point(64, 440)
      Me.HScrollBar1.Name = "HScrollBar1"
      Me.HScrollBar1.Size = New System.Drawing.Size(1079, 18)
      ...
      Me.VScrollBar1.Location = New System.Drawing.Point(1142, 136)
      Me.VScrollBar1.Name = "VScrollBar1"
      Me.VScrollBar1.Size = New System.Drawing.Size(18, 304)
      ...
      Me.ClientSize = New System.Drawing.Size(1160, 478)
...
#End Region
   ...
   Private Sub LeggiDatiConfig()
      Try
         ...
         If DatiConfig.GetValue("WSPlanning") = CStr(FormWindowState.Maximized) Then
            Me.WindowState = FormWindowState.Maximized
         ElseIf DatiConfig.GetValue("WSPlanning") = CStr(FormWindowState.Minimized) Then
            Me.WindowState = FormWindowState.Minimized
         Else
            If DatiConfig.GetValue("APlanning") <> "" Then
               Me.Height = CInt(DatiConfig.GetValue("APlanning"))
            Else
               Me.Height = PLANNING_ALTEZZA
            End If

            If DatiConfig.GetValue("LPlanning") <> "" Then
               Me.Width = CInt(DatiConfig.GetValue("LPlanning"))
            Else
               Me.Width = PLANNING_LARGHEZZA
            End If

            If DatiConfig.GetValue("PlanningX") <> "" Then
               Me.Location = New Point(CInt(DatiConfig.GetValue("PlanningX")), Me.Location.Y)
            End If

            If DatiConfig.GetValue("PlanningY") <> "" Then
               Me.Location = New Point(Me.Location.X, CInt(DatiConfig.GetValue("PlanningY")))
            End If

         End If

         If DatiConfig.GetValue("LCelle") = "" Then
            Larghezza.Text = "150"
            LARGHEZZA_CELLE = 150
         Else
            Larghezza.Text = CShort(DatiConfig.GetValue("LCelle"))
            LARGHEZZA_CELLE = Larghezza.Text
         End If

         If DatiConfig.GetValue("VCosto") = "" Then
            ckbVisCosto.Checked = False
         Else
            ckbVisCosto.Checked = DatiConfig.GetValue("VCosto")
         End If
   ...
   Private Sub SalvaDatiConfig()
      Try
         ...
         DatiConfig.SetValue("WSPlanning", Me.WindowState)
         DatiConfig.SetValue("APlanning", Me.Height)
         DatiConfig.SetValue("LPlanning", Me.Width)
         DatiConfig.SetValue("PlanningX", Me.Location.X)
         DatiConfig.SetValue("PlanningY", Me.Location.Y)
         DatiConfig.SetValue("LCelle", Larghezza.Text)
         DatiConfig.SetValue("VCosto", ckbVisCosto.Checked)
   ...
   Private Sub DisegnaRisorse(ByVal nome As String, ByVal colore As String, ByVal note As String, ByVal costo As String, ByVal id As Integer)
      Try
         ...
         'AddHandler Risorsa(NumRisorse).DoubleClick, AddressOf Risorsa_DoubleClick
         'AddHandler Risorsa(NumRisorse).GotFocus, AddressOf Risorsa_GotFocus
   ...
   Public Sub LeggiDatiRisorse(ByVal tabella As String)
      ' Dichiara un oggetto connessione.
      Dim cn As New OleDbConnection(ConnString)
   ...
   Public Function NumeroRisorse(ByVal tabella As String) As Short
      ' Dichiara un oggetto connessione.
      Dim cn As New OleDbConnection(ConnString)
   ...
   Private Sub frmPlanningP_FormClosed(sender As Object, e As System.Windows.Forms.FormClosedEventArgs) Handles Me.FormClosed
      Try
         ...
         g_frmMain.RimuoviFormMenuSeleziona(g_frmPP)
