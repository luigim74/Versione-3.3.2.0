...
' Data creazione:       09/09/2020
' Data ultima modifica: 09/09/2020
' Descrizione:          Anagrafica Agenzie Camerieri.
' Note:
'
' Elenco Attivita:
'
...
Public Class frmAgenzieCamerieri
...
#Region " Codice generato da Progettazione Windows Form "
   ...
   <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
      ...
      Dim resources As System.ComponentModel.ComponentResourceManager = New System.ComponentModel.ComponentResourceManager(GetType(frmAgenzieCamerieri))
      ...
      Me.TabControl1.Size = New System.Drawing.Size(543, 315)
      ...
      Me.TabPage1.Size = New System.Drawing.Size(535, 289)
      ...
      Me.TabPage3.Size = New System.Drawing.Size(545, 297)
      ...
      Me.TabPage4.Size = New System.Drawing.Size(535, 289)
      ...
      Me.TabPage6.Size = New System.Drawing.Size(545, 297)
      ...
      Me.txtNote.Size = New System.Drawing.Size(545, 297)
      ...
      'TabPage2
      '
      Me.TabPage2.Controls.Add(Me.lstvElencoCamerieri)
      Me.TabPage2.Location = New System.Drawing.Point(4, 22)
      Me.TabPage2.Name = "TabPage2"
      Me.TabPage2.Padding = New System.Windows.Forms.Padding(3)
      Me.TabPage2.Size = New System.Drawing.Size(535, 289)
      Me.TabPage2.TabIndex = 6
      Me.TabPage2.Text = "Elenco camerieri"
      ...
      Me.Name = "frmAgenzieCamerieri"
      Me.ShowInTaskbar = False
      Me.StartPosition = System.Windows.Forms.FormStartPosition.CenterScreen
      Me.Text = "Agenzie camerieri"
...
#End Region
   ...
   Const NOME_TABELLA As String = "AgenzieCamerieri"
    ...
    Private Sub InserisciImmagine()
        Try
            ...
            CAgenzieCamerieri.Immagine = OpenFileDialog1.FileName

            If File.Exists(CAgenzieCamerieri.Immagine) = True Then
                Dim bmp As New Bitmap(CAgenzieCamerieri.Immagine)
                picFoto.Image = bmp
            End If
    ...
    Private Sub EliminaImmagine()
        Try
            If Not (picFoto.Image Is Nothing) Then
                ...
                CAgenzieCamerieri.Immagine = String.Empty
            End If
   ...
   Private Sub AgenzieCamerieri_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        Try
         ...
         If Me.Tag <> "" Then
            ...
            CAgenzieCamerieri.LeggiDati(NOME_TABELLA, Me.Tag)

            ' Assegna i dati dei campi della classe alle caselle di testo.
            txtCodice.Text = CAgenzieCamerieri.Codice
            txtRagSoc.Text = CAgenzieCamerieri.RagSociale
            txtPIva.Text = CAgenzieCamerieri.PIva
            txtIndirizzo1.Text = CAgenzieCamerieri.Indirizzo1
            txtCap.Text = CAgenzieCamerieri.Cap
            cmbCittà.Text = CAgenzieCamerieri.Città
            txtProv.Text = CAgenzieCamerieri.Provincia
            txtRegione.Text = CAgenzieCamerieri.Regione
            cmbNazione.Text = CAgenzieCamerieri.Nazione
            txtContatto.Text = CAgenzieCamerieri.Contatto
            txtTelCasa.Text = CAgenzieCamerieri.TelCasa
            txtTelUfficio.Text = CAgenzieCamerieri.TelUfficio
            txtCell.Text = CAgenzieCamerieri.Cell
            txtFax.Text = CAgenzieCamerieri.Fax
            txtEmail.Text = CAgenzieCamerieri.Email
            txtPec.Text = CAgenzieCamerieri.PEC
            txtInternet.Text = CAgenzieCamerieri.Internet
            txtNote.Text = CAgenzieCamerieri.Note

            If CAgenzieCamerieri.Immagine <> Nothing Then
               If File.Exists(CAgenzieCamerieri.Immagine) = True Then
                  Dim bmp As New Bitmap(CAgenzieCamerieri.Immagine)
                  picFoto.Image = bmp
               End If
    ...
    Private Sub AgenzieCamerieri_Closed(ByVal sender As Object, ByVal e As System.EventArgs) Handles MyBase.Closed
        If Me.Tag <> "0" Then
