...
#End Region
    ...
    Private Function SalvaDati() As Boolean
      Try
         ...
         With CMenu
            ...
            .PercorsoImgQR = eui_txtPercorsoImmagineCodiceQR.Text
            ...
            ' Carica l'immagine.
            If IsNothing(.Immagine) = True Then
               .Immagine = Nothing
               .PercorsoImg = String.Empty
            End If

            ' Carica l'immagine.
            If IsNothing(.ImmagineQR) = True Then
               .ImmagineQR = Nothing
               .PercorsoImgQR = String.Empty
            Else
               ' Salva l'immagine in un campo BLOB del database.
               .ImmagineQR = CreaStream(eui_txtPercorsoImmagineCodiceQR.Text)
            End If
   ...
   Private Sub GeneraCodiciBarre(ByVal indirizzo As String, ByVal formatoImg As String)
      Try
         If indirizzo <> String.Empty Then
            ...
            If File.Exists(eui_txtPercorsoImmagineCodiceQR.Text) = True Then
               File.Delete(eui_txtPercorsoImmagineCodiceQR.Text)
            End If
   ...
   Private Sub InserisciImmagine()
      Try
         ...
         OpenFileDialog1.FileName = RestituisciNomeFileDirectory(CMenu.PercorsoImg)
         OpenFileDialog1.InitialDirectory = Environment.GetFolderPath(Environment.SpecialFolder.MyPictures)
         OpenFileDialog1.ShowDialog()

         CMenu.PercorsoImg = OpenFileDialog1.FileName
         ' Salva l'immagine in un campo BLOB del database.
         CMenu.Immagine = CreaStream(OpenFileDialog1.FileName)
   ...
   Private Sub EliminaImmagine()
      Try
         If Not (picImmagine.Image Is Nothing) Then
            ...
            CMenu.Immagine = CreaStream(Application.StartupPath & PERCORSO_IMG_LOGO)
            CMenu.PercorsoImg = Application.StartupPath & PERCORSO_IMG_LOGO
         End If
   ...
   Private Sub EliminaImmagineCodiceQR()
      Try
         If Not (picCodiceQR.Image Is Nothing) Then
            ...
            CMenu.ImmagineQR = CreaStream(Application.StartupPath & PERCORSO_IMG_LOGO)
            CMenu.PercorsoImgQR = Application.StartupPath & PERCORSO_IMG_LOGO
   ...
   Private Sub Menu_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
      Try
         ...
         eui_txtPercorsoImmagineCodiceQR.Text = CMenu.PercorsoImgQR
         eui_txtPercorsoReport.Text = CMenu.Modello

         ' Carica l'immagine del Logo.
         If CMenu.PercorsoImg <> Nothing Then
            If File.Exists(CMenu.PercorsoImg) = True Then
               Dim bmp As New Bitmap(CMenu.PercorsoImg)
               picImmagine.Image = bmp
            End If
         End If

         ' Carica l'immagine del Codice QR.
         If CMenu.PercorsoImgQR <> Nothing Then
            If File.Exists(CMenu.PercorsoImgQR) = True Then
               Dim bmp As New Bitmap(CMenu.PercorsoImgQR)
   ...
   Private Sub eui_ApriModello_Click(sender As Object, e As EventArgs) Handles eui_ApriModello.Click
      Try
         ...
         OpenFileDialog1.InitialDirectory = Application.StartupPath & "\Reports\Menu"
         OpenFileDialog1.ShowDialog()
