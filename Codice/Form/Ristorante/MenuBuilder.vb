      ...
      Try
         ...
         With CMenu
            ...
            If IsNothing(.Immagine) = True Then
               .Immagine = CreaStream(Application.StartupPath & PERCORSO_IMG_LOGO)
               .PercorsoImg = String.Empty
            End If

            ' Carica l'immagine.
            If IsNothing(.ImmagineQR) = True Then
               .ImmagineQR = CreaStream(Application.StartupPath & PERCORSO_IMG_LOGO)
   ...
   Private Sub GeneraCodiciBarre(ByVal indirizzo As String, ByVal formatoImg As String)
      Try
         If indirizzo <> String.Empty Then
            ...
            CMenu.ImmagineQR = CreaStream(eui_txtPercorsoImmagineCodiceQR.Text)
         Else
   ...
   Private Sub EliminaImmagine()
      Try
         If Not (picImmagine.Image Is Nothing) Then
            ...
            CMenu.Immagine = Nothing
            CMenu.PercorsoImg = String.Empty
         End If
   ...
   Private Sub EliminaImmagineCodiceQR()
      Try
         If Not (picCodiceQR.Image Is Nothing) Then
            ...
            CMenu.ImmagineQR = Nothing
            CMenu.PercorsoImgQR = String.Empty
