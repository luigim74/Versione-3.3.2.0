...
#End Region
   ...
   Private Sub StampaElenco(ByVal sqlRep As String, ByVal nomeDoc As String, ByVal nomeStampante As String, ByVal numCopie As Short)
      Try
         ...
         oleAdapter1.Fill(ds, TAB_CORRISPETTIVI)
   ...
   Private Sub ToolBar1_ButtonClick(ByVal sender As System.Object, ByVal e As System.Windows.Forms.ToolBarButtonClickEventArgs) Handles ToolBar1.ButtonClick
      Select Case e.Button.Tag
         ...
         Case "Stampa"
            ...
            If PrintDialog1.ShowDialog() = DialogResult.OK Then
               StampaElenco(repSql, PERCORSO_REP_CORRISPETTIVI_A4, PrintDialog1.PrinterSettings.PrinterName, PrintDialog1.PrinterSettings.Copies)
            End If
         ...
         Case "Anteprima"
            ...
            AnteprimaDiStampa(PERCORSO_REP_CORRISPETTIVI_A4, TAB_CORRISPETTIVI, repSql)
