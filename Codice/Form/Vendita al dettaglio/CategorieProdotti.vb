...
Public Class frmCategorieProdotti
...
#Region " Codice generato da Progettazione Windows Form "
   ...
   <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
      ...
      Dim resources As System.ComponentModel.ComponentResourceManager = New System.ComponentModel.ComponentResourceManager(GetType(frmCategorieProdotti))
      ...
      Me.Name = "frmCategorieProdotti"
      Me.ShowInTaskbar = False
      Me.StartPosition = System.Windows.Forms.FormStartPosition.CenterScreen
      Me.Text = "Categorie prodotti"
...
#End Region
   ...
   Public ACatProdotti As New CategorieProdotti

   Const NOME_TABELLA As String = "CategorieProdotti"
   ...
   Private Function SalvaDati() As Boolean
      Try
         ...
         With ACatProdotti
            ...
            ACatProdotti.Colore = cmdColore.BackColor.ToArgb
   ...
   Private Sub InserisciIcona()
      Try
         With OpenFileDialog1
            ...
            ACatProdotti.Icona = .FileName

         End With

         If File.Exists(ACatProdotti.Icona) = True Then
            Dim bmp As New Bitmap(ACatProdotti.Icona)
   ...
   Private Sub ModificaColore()
      Try
         With ColorDialog1()
            ...
            ACatProdotti.Colore = Convert.ToString(.Color.ToArgb)
   ...
   Private Sub frmCategorieProdotti_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
      Try
         ...
         Else
            ...
            ACatProdotti.Colore = Convert.ToString(Color.White.ToArgb)
         End If
   ...
   Private Sub frmCategorieProdotti_Closed(ByVal sender As Object, ByVal e As System.EventArgs) Handles MyBase.Closed
      If Me.Tag <> "0" Then
         ' Registra loperazione effettuata dall'operatore identificato.
         g_frmMain.RegistraOperazione(TipoOperazione.Annulla, String.Empty, MODULO_ANAGRAFICA_CAT_PRODOTTI)
      End If
   End Sub
      ...
      Select Case e.Button.Tag
         Case "Salva"
            ...
            If SalvaDati() = True Then
               ...
               If IsNothing(g_frmCatProdotti) = False Then
                  ' Aggiorna la griglia dati.
                  g_frmCatProdotti.AggiornaDati()
               End If
               ...
               ' Registra loperazione effettuata dall'operatore identificato.
               Dim strDescrizione As String = " (" & ACatProdotti.Descrizione & ")"

               g_frmMain.RegistraOperazione(TipoOperazione.Salva, strDescrizione, MODULO_ANAGRAFICA_CAT_PRODOTTI)
            End If
   ...
   Private Sub cmdRipristina_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles cmdRipristina.Click
      ...
      ACatProdotti.Colore = Convert.ToString(Color.DodgerBlue.ToArgb)
      EliminaIcona()
   End Sub
