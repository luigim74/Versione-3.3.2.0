...
#Region "Scarico articoli"
   ...
   Private Sub RipristinaIngredientiScaricati()
      Try
         ...
         rifDoc = DataGridView1.Item(COLONNA_ID, DataGridView1.CurrentCell.RowIndex).Value
...
#End Region
   ...
   Private Sub RipristinaStatistiche()
      Try
         ...
         ' Legge il numero dell'ultimo documento creato.
         rifDoc = DataGridView1.Item(COLONNA_ID, DataGridView1.CurrentCell.RowIndex).Value.ToString
   ...
   Public Sub AggiornaDatiPeriodo()
      Try
         ...
         If frmFiltroPerido.ShowDialog = Windows.Forms.DialogResult.OK Then
            ...
            sql = String.Format("Select TOP {0} * FROM {1} WHERE DataInizio BETWEEN #{2}# And #{3}# ORDER BY DataInizio ASC", DIM_PAGINA_GRANDE, TAB_CAUSALI_NOLEGGIO, dataDal, dataAl)
            repSql = sql
            LeggiDati("(" & sql & ")", sql)
   ...
   Public Sub AggiornaDatiMese()
      Try
         ...
         sql = String.Format("Select TOP {0} * FROM {1} WHERE DataInizio BETWEEN #{2}# And #{3}# ORDER BY DataInizio ASC", DIM_PAGINA_GRANDE, TAB_CAUSALI_NOLEGGIO, InizioMese, FineMese)
   ...
   Public Sub AggiornaDatiAnno()
      Try
         ...
         sql = String.Format("Select TOP {0} * FROM {1} WHERE DataInizio BETWEEN #{2}# And #{3}# ORDER BY DataInizio ASC", DIM_PAGINA_GRANDE, TAB_CAUSALI_NOLEGGIO, InizioAnno, FineAnno)
   ...
   Public Sub AnnullaDocumento()
      Try
         ...
         Else
            ModificaStatoDocumento(TAB_CAUSALI_NOLEGGIO, Id, "")
         End If
   ...
   Private Sub FiltraDatiArticoli(ByVal rif_noleggio As Integer)
      Try
         ...
         numRecordArticoli = LeggiNumRecordIngredienti(TAB_DETTAGLI_CAUSALI_NOLEGGIO, rif_noleggio)
