...
' Data creazione:       26/06/2021
' Data ultima modifica: 28/06/2021
' Descrizione:          Anagrafica Stato Noleggi.
' Note:
' Elenco Attivita:
'
' ******************************************************************************************
...
#Region " Codice generato da Progettazione Windows Form "
    ...
    <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
      ...
      Dim resources As System.ComponentModel.ComponentResourceManager = New System.ComponentModel.ComponentResourceManager(GetType(frmStatoNoleggi))
      ...
      Me.Name = "frmStatoNoleggi"
      Me.ShowInTaskbar = False
      Me.StartPosition = System.Windows.Forms.FormStartPosition.CenterScreen
      Me.Text = "Stato noleggio"
...
#End Region
   ...
   Public CStatoNoleggi As New StatoNoleggi

    Const NOME_TABELLA As String = "StatoNoleggi"
    ...
    Private Sub ModificaColore()
        Try
            With ColorDialog1()
                ...
                CStatoNoleggi.Colore = Convert.ToString(.Color.ToArgb)
    ...
    Private Sub frmStatoNoleggi_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        Try
            ...
            Else
                ...
                CStatoNoleggi.Colore = Convert.ToString(Color.White.ToArgb)
            End If
    ...
    Private Sub frmStatoNoleggi_FormClosed(ByVal sender As Object, ByVal e As System.EventArgs) Handles MyBase.FormClosed
        ' A_TODO: da modificare!
        'If Me.Tag <> "0" Then
        ...
        Select Case e.Button.Tag
            Case "Salva"
                ...
                If SalvaDati() = True Then
                    ...
                    If IsNothing(g_frmStatoNoleggi) = False Then
                    ...
                    ' Registra loperazione effettuata dall'operatore identificato.
                    Dim strDescrizione As String = " (" & CStatoNoleggi.Descrizione & ")"
                    ' A_TODO: da modificare!
